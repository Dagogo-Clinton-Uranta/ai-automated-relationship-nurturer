...
import nurtureproblem from 'src/images/nurtureproblem.jpeg'
  ...
  return (
    ...
    <img  className='CTAboximg1' src={nurtureproblem} style={{width:"85%",height:"85%"}} alt="search image"/>
      ...
      <h1 style={{fontWeight:"700",fontSize:"2.8rem",marginBottom:"15px"}}>Opportunities rarely die instantly.  They go cold over time.{/*<span className="text-accent">  get the Job! </span>*/}</h1>
         ...
         Teams spend enormous effort generating meetings and building pipeline — but many valuable relationships fade simply because there isn’t consistent, meaningful follow-up after the first conversation. Reps get busy. Priorities shift.
        </p>

        <p style={{fontSize:"1.8rem",marginBottom:"15px"}}>
        Outreach becomes inconsistent.And over time, promising opportunities quietly disappear from the pipeline. Most companies rely on generic nurture campaigns, sporadic check-ins, manual reminders or no follow-up strategy at all. As a result, relationships that could have turned into future revenue are forgotten long before timing aligns.
        </p>
