...
import { setSelectedInteraction } from 'redux/reducers/user.slice';
                        ...
                        connUsers.messageQueue.map((interaction, idx) => {
                          ...
                          return (
                            <ListItem
                              ...
                              button
                              className={clsx('px-16 py-12 min-h-92', {
                                active: interaction.uid === selectedChatUser?.uid,
                              })}
                              onClick={() => {
                                  dispatch(setSelectedInteraction(interaction));
                                  
                                  props.onClick && props.onClick(interaction.uid);
                                }}
